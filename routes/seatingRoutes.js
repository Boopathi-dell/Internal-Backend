...
router.post("/generate", async (req, res) => {
  try {
    const { date, iqacNumber, examName, academicYear, branchName, subHeaderText, noteText, showEcSignature, showHodSignature, rosterIds, hallIds, shuffleClasses, libraryFillPreference, excludedStudents = [] } = req.body;
    ...
    res.json({ examDate: date, examName, academicYear, branchName, subHeaderText, iqacNumber, noteText, showEcSignature, showHodSignature, allocations });
...
router.post("/plans", async (req, res) => {
  try {
    const { examDate, examName, academicYear, branchName, subHeaderText, iqacNumber, noteText, showEcSignature, showHodSignature, allocations } = req.body;
